...
export default function DistributorsPage() {
  ...
  const [form, setForm] = useState({ name: '', contact_person_name: '', pincode: '', gst_number: '', mobile_1: '', mobile_2: '', address: '', description: '', place: '', state_id: '', district_id: '', taluka_id: '', village_id: '', latitude: '', longitude: '' })
  ...
  function openAdd() {
    setEditing(null)
    setForm({ name: '', contact_person_name: '', pincode: '', gst_number: '', mobile_1: '', mobile_2: '', address: '', description: '', place: '', state_id: '', district_id: '', taluka_id: '', village_id: '', latitude: '', longitude: '' })
    ...
    <>
      ...
      <Modal title={editing ? 'Edit Distributor' : 'Add Distributor'} isOpen={open} onClose={() => setOpen(false)} onSave={handleSave} isSaving={saving} size="lg">
        <div>
          ...
          <input type="text" value={form.name} onChange={F('name')} placeholder="Distributor account name" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
